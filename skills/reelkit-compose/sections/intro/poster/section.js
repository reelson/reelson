...
tl.fromTo('#intro .l', { scale: 1.3, opacity: 0.6, x: (i, el, all) => (i - (all.length - 1) / 2) * 26 },
  { scale: 1, opacity: 1, x: 0, duration: 1.4, ease: 'sine.inOut', stagger: { each: 0.06, from: 'center' } }, c0);
tl.fromTo('#intro .brand-line', { scaleX: 1.3, opacity: 0.6 }, { scaleX: 1, opacity: 1, duration: 1.3, ease: 'sine.inOut' }, c0 + 0.25);
tl.fromTo('#intro .brand-sub', { scale: 1.3, opacity: 0.6 }, { scale: 1, opacity: 1, duration: 1.3, ease: 'sine.inOut' }, c0 + 0.35);
tl.fromTo('#intro .title', { scale: 1.3, opacity: 0.65 }, { scale: 1, opacity: 1, duration: 1.4, ease: 'sine.inOut' }, c0 + 0.2);
...
tl.fromTo('#intro .stack', { y: -30 }, { y: -1150, duration: 0.9, ease: 'power3.inOut', ...later }, section.exit);
