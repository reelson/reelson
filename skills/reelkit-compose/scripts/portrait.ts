 ...
 *   - a mobile recording (`reelkit record --mobile`: the app at a phone viewport) — shown whole
 ...
 *     what the demo is working on (reelkit-record's `focus`: the element it moved to, with its
