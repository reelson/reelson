...
reelkit ships or downloads the following. Check each licence before using reelkit output
commercially or redistributing it.

| Component | Where | Licence |
|---|---|---|
| **GSAP 3.14.2** (GreenSock) | vendored: `skills/reelkit-compose/templates/classic/assets/vendor/gsap.min.js` | GreenSock Standard "No Charge" License — https://gsap.com/standard-license (not an OSI licence) |
